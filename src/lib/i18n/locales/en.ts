export const en = {
  facets: {
    ...
    contents: {
      ...
      showPropertyTitles: {
        title: "Show Property Titles",
      },
      showMarkdown: {
        title: "Show Markdown",
      },
      markdownMaxLength: {
        title: "Markdown Max Length",
      },
      markdownMaxHeight: {
        title: "Markdown Max Height",
      },
    },
    images: {
      title: "Images",
